...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GridlyClient.GridApi();
  });
  ...
  describe('GridApi', function() {
    ...
    describe('listTemplateGrids', function() {
      it('should call listTemplateGrids successfully', function(done) {
        //uncomment below and update the code to test listTemplateGrids
        //instance.listTemplateGrids(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
