...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GridlyClient.GlossaryApi();
  });
  ...
  describe('GlossaryApi', function() {
    ...
    describe('exportFile', function() {
      it('should call exportFile successfully', function(done) {
        //uncomment below and update the code to test exportFile
        //instance.exportFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importFile', function() {
      it('should call importFile successfully', function(done) {
        //uncomment below and update the code to test importFile
        //instance.importFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
