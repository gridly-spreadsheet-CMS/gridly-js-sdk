...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GridlyClient.TransmemApi();
  });
  ...
  describe('TransmemApi', function() {
    ...
    describe('cleanup', function() {
      it('should call cleanup successfully', function(done) {
        //uncomment below and update the code to test cleanup
        //instance.cleanup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createWithFile', function() {
      it('should call createWithFile successfully', function(done) {
        //uncomment below and update the code to test createWithFile
        //instance.createWithFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importTmx', function() {
      it('should call importTmx successfully', function(done) {
        //uncomment below and update the code to test importTmx
        //instance.importTmx(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listTM', function() {
      it('should call listTM successfully', function(done) {
        //uncomment below and update the code to test listTM
        //instance.listTM(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
