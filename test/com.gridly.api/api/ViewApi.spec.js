...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GridlyClient.ViewApi();
  });
  ...
  describe('ViewApi', function() {
    ...
    describe('importView', function() {
      it('should call importView successfully', function(done) {
        //uncomment below and update the code to test importView
        //instance.importView(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
