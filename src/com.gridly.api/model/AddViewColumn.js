...
/**
 * The AddViewColumn model module.
 * @module com.gridly.api/model/AddViewColumn
 * @version 5.9.0
 */
class AddViewColumn {
    /**
     * Constructs a new <code>AddViewColumn</code>.
     * @alias module:com.gridly.api/model/AddViewColumn
     */
    constructor() { 
        
        AddViewColumn.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddViewColumn</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.gridly.api/model/AddViewColumn} obj Optional instance to populate.
     * @return {module:com.gridly.api/model/AddViewColumn} The populated <code>AddViewColumn</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddViewColumn();
    ...
    /**
     * Validates the JSON data with respect to <code>AddViewColumn</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddViewColumn</code>.
     */
 ...
 * @member {String} id
 */
AddViewColumn.prototype['id'] = undefined;

/**
 * @member {Boolean} editable
 */
AddViewColumn.prototype['editable'] = undefined;

/**
 * @member {String} name
 */
AddViewColumn.prototype['name'] = undefined;

/**
 * @member {String} description
 */
AddViewColumn.prototype['description'] = undefined;

/**
 * @member {module:com.gridly.api/model/AddViewColumn.TypeEnum} type
 */
AddViewColumn.prototype['type'] = undefined;

/**
 * @member {module:com.gridly.api/model/AddViewColumn.LanguageCodeEnum} languageCode
 */
AddViewColumn.prototype['languageCode'] = undefined;

/**
 * @member {module:com.gridly.api/model/AddViewColumn.LocalizationTypeEnum} localizationType
 */
AddViewColumn.prototype['localizationType'] = undefined;

/**
 * @member {module:com.gridly.api/model/NumberFormat} numberFormat
 */
AddViewColumn.prototype['numberFormat'] = undefined;

/**
 * @member {Array.<String>} selectionOptions
 */
AddViewColumn.prototype['selectionOptions'] = undefined;

/**
 * @member {module:com.gridly.api/model/Reference} reference
 */
AddViewColumn.prototype['reference'] = undefined;

/**
 * @member {module:com.gridly.api/model/Formula} formula
 */
AddViewColumn.prototype['formula'] = undefined;

/**
 * @member {module:com.gridly.api/model/DateTimeFormat} dateTimeFormat
 */
AddViewColumn.prototype['dateTimeFormat'] = undefined;
 ...
 * @readonly
 */
AddViewColumn['LanguageCodeEnum'] = {
 ...
 * @readonly
 */
AddViewColumn['LocalizationTypeEnum'] = {
