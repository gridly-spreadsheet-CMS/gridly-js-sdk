...
class CreateTransMem {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTransMem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTransMem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTransMem.RequiredProperties) {
            if (!data[property]) {
...
CreateTransMem.RequiredProperties = ["name"];
 ...
 */
CreateTransMem.prototype['allowAlternative'] = undefined;
